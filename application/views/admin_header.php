						...
						<ul class="nav navbar-nav">
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									<li>
										<a href="<?php echo site_url('admin/addItemUsers') ?>"><img src="<?php echo base_url(); ?>ext_files/images/128px/pencil.png" style="height:20px;width:20px;"> Item Users</a>
									</li>
									<li>
									...
									<li>
										<a href="<?php echo site_url('admin/addEquipmentType') ?>"><img src="<?php echo base_url(); ?>ext_files/images/128px/shop.png" style="height:20px;width:20px;"> Add Equipment Type</a>
									</li>
									...
									<li>
										<a href="<?php echo site_url('admin/searchFitnessHistory') ?>"><img src="<?php echo base_url(); ?>ext_files/images/128px/document.png" style="height:20px;width:20px;"> Fitness History</a>
									</li>
									<!-- <li>
										<a href="<?php echo site_url('admin/inventory_system') ?>"><img src="<?php echo base_url(); ?>ext_files/images/128px/document.png" style="height:20px;width:20px;"> Inventory</a>
									</li> -->									
								</ul>
							</li>
						</ul>

...
<!-- 									<li>
										<a href="<?php echo site_url('admin/addCustomer') ?>"><img src="<?php echo base_url(); ?>ext_files/images/128px/pencil.png" style="height:20px;width:20px;"> Item Users</a>
									</li> -->
									<li>
										<a href="<?php echo site_url('admin/addProducts') ?>"><img src="<?php echo base_url(); ?>ext_files/images/128px/paintbrush2.png" style="height:20px;width:20px;"> Equipments</a>
									</li>												
								</ul>
							</li>
						</ul>
